...
wget --quiet -O nginx.zip "https://nginx.org/download/nginx-$NGINX_VER.zip"
...
wget --quiet -O php.zip "https://windows.php.net/downloads/releases/$PHP_VER.zip"
unzip -d webtlo-win/php php.zip

# Web-TLO: https://github.com/keepers-team/webtlo
wget --quiet -O webtlo.zip "https://github.com/keepers-team/webtlo/archive/refs/tags/$WEBTLO_VER.zip"
